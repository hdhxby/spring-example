...
public class DateFormatterStandardBeanExpressionResolverTest {

    private Logger logger = LoggerFactory.getLogger(DateFormatterStandardBeanExpressionResolverTest.class);
